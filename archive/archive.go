...
func StartArchiving() {
	if shouldArchive {
		...
		archivePeriodically("answerercountry", 10*time.Minute)
		archivePeriodically("offereranswerercountries", 10*time.Minute)
		archivePeriodically("operatingsystem", 10*time.Minute)
	} else {
